...
CREATE TABLE `image` (
  ...
  CONSTRAINT `fk_i_s_si` FOREIGN KEY (`service_id`) REFERENCES `service` (`service_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `image` VALUES ('25gNacctCDPUVPb8QQx','25gNaeCHTRGbdrTCqUx',NULL,'app/media/product/137279.jpg',1),('25gNrszjxb3GUjAyAT7','25gNrtYp4WPFHxbVZJI',NULL,'app/media/product/hmgoepprod.jpeg',1);
...
INSERT INTO `product` VALUES ('25gNaeCHTRGbdrTCqUx','Blue Dog Lead',120,0,'25e4orCMpwimZ7PosXL'),('25gNrtYp4WPFHxbVZJI','Blue Cat Lead',120,0,'25e4pOk9ANpVrPmPHxs');
...
INSERT INTO `product_detail` VALUES ('25gNabWl4COnY82BnUv','25gNaeCHTRGbdrTCqUx','This is Blue Dog Lead',25000),('25gNrz7UiRXYwqNJQqz','25gNrtYp4WPFHxbVZJI','This is Cat Dog Lead',25000);
...
-- Dump completed on 2022-02-27 14:21:13
